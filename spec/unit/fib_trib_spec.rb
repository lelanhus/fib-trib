...
describe FibTrib do
  ...
  context "pentanacci sequence" do
    it "#sequence should return 32 when n = 4 and pos = 6" do
     sequence(4,8).should == 125      
    end
  end
  
  def sequence(n,pos = 0)
    FibTrib.sequence(n,pos)
  end
end